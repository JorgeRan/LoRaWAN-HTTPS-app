...
function serialize_api_CreateBlynkIntegrationRequest(arg) {
  if (!(arg instanceof api_application_pb.CreateBlynkIntegrationRequest)) {
    throw new Error('Expected argument of type api.CreateBlynkIntegrationRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_CreateBlynkIntegrationRequest(buffer_arg) {
  return api_application_pb.CreateBlynkIntegrationRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_api_DeleteBlynkIntegrationRequest(arg) {
  if (!(arg instanceof api_application_pb.DeleteBlynkIntegrationRequest)) {
    throw new Error('Expected argument of type api.DeleteBlynkIntegrationRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_DeleteBlynkIntegrationRequest(buffer_arg) {
  return api_application_pb.DeleteBlynkIntegrationRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_api_GetBlynkIntegrationRequest(arg) {
  if (!(arg instanceof api_application_pb.GetBlynkIntegrationRequest)) {
    throw new Error('Expected argument of type api.GetBlynkIntegrationRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_GetBlynkIntegrationRequest(buffer_arg) {
  return api_application_pb.GetBlynkIntegrationRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_api_GetBlynkIntegrationResponse(arg) {
  if (!(arg instanceof api_application_pb.GetBlynkIntegrationResponse)) {
    throw new Error('Expected argument of type api.GetBlynkIntegrationResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_GetBlynkIntegrationResponse(buffer_arg) {
  return api_application_pb.GetBlynkIntegrationResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_api_UpdateBlynkIntegrationRequest(arg) {
  if (!(arg instanceof api_application_pb.UpdateBlynkIntegrationRequest)) {
    throw new Error('Expected argument of type api.UpdateBlynkIntegrationRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_UpdateBlynkIntegrationRequest(buffer_arg) {
  return api_application_pb.UpdateBlynkIntegrationRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
createBlynkIntegration: {
    path: '/api.ApplicationService/CreateBlynkIntegration',
    requestStream: false,
    responseStream: false,
    requestType: api_application_pb.CreateBlynkIntegrationRequest,
    responseType: google_protobuf_empty_pb.Empty,
    requestSerialize: serialize_api_CreateBlynkIntegrationRequest,
    requestDeserialize: deserialize_api_CreateBlynkIntegrationRequest,
    responseSerialize: serialize_google_protobuf_Empty,
    responseDeserialize: deserialize_google_protobuf_Empty,
  },
  // Get Blynk integration.
getBlynkIntegration: {
    path: '/api.ApplicationService/GetBlynkIntegration',
    requestStream: false,
    responseStream: false,
    requestType: api_application_pb.GetBlynkIntegrationRequest,
    responseType: api_application_pb.GetBlynkIntegrationResponse,
    requestSerialize: serialize_api_GetBlynkIntegrationRequest,
    requestDeserialize: deserialize_api_GetBlynkIntegrationRequest,
    responseSerialize: serialize_api_GetBlynkIntegrationResponse,
    responseDeserialize: deserialize_api_GetBlynkIntegrationResponse,
  },
  // Update Blynk integration.
updateBlynkIntegration: {
    path: '/api.ApplicationService/UpdateBlynkIntegration',
    requestStream: false,
    responseStream: false,
    requestType: api_application_pb.UpdateBlynkIntegrationRequest,
    responseType: google_protobuf_empty_pb.Empty,
    requestSerialize: serialize_api_UpdateBlynkIntegrationRequest,
    requestDeserialize: deserialize_api_UpdateBlynkIntegrationRequest,
    responseSerialize: serialize_google_protobuf_Empty,
    responseDeserialize: deserialize_google_protobuf_Empty,
  },
  // Delete Blynk integration.
deleteBlynkIntegration: {
    path: '/api.ApplicationService/DeleteBlynkIntegration',
    requestStream: false,
    responseStream: false,
    requestType: api_application_pb.DeleteBlynkIntegrationRequest,
    responseType: google_protobuf_empty_pb.Empty,
    requestSerialize: serialize_api_DeleteBlynkIntegrationRequest,
    requestDeserialize: deserialize_api_DeleteBlynkIntegrationRequest,
    responseSerialize: serialize_google_protobuf_Empty,
    responseDeserialize: deserialize_google_protobuf_Empty,
  },
