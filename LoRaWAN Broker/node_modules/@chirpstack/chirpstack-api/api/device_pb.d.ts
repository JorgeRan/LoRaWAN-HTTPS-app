...
export class ListDevicesRequest extends jspb.Message {
  ...
  getOrderBy(): ListDevicesRequest.OrderByMap[keyof ListDevicesRequest.OrderByMap];
  setOrderBy(value: ListDevicesRequest.OrderByMap[keyof ListDevicesRequest.OrderByMap]): void;
...
export namespace ListDevicesRequest {
  export type AsObject = {
    ...
    orderBy: ListDevicesRequest.OrderByMap[keyof ListDevicesRequest.OrderByMap],
    orderByDesc: boolean,
    tagsMap: Array<[string, string]>,
    deviceProfileId: string,
  }
...
export class EnqueueDeviceQueueItemRequest extends jspb.Message {
  ...
  setFlushQueue(value: boolean): void;
