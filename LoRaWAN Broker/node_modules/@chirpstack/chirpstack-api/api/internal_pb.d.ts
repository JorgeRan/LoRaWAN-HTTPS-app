...
export class RegionChannel extends jspb.Message {
  ...
  clearDataRatesList(): void;
  getDataRatesList(): Array<number>;
  setDataRatesList(value: Array<number>): void;
  addDataRates(value: number, index?: number): number;
