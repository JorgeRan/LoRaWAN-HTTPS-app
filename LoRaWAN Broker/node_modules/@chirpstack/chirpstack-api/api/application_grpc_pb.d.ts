...
interface IApplicationServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  createBlynkIntegration: grpc.MethodDefinition<api_application_pb.CreateBlynkIntegrationRequest, google_protobuf_empty_pb.Empty>;
  getBlynkIntegration: grpc.MethodDefinition<api_application_pb.GetBlynkIntegrationRequest, api_application_pb.GetBlynkIntegrationResponse>;
  updateBlynkIntegration: grpc.MethodDefinition<api_application_pb.UpdateBlynkIntegrationRequest, google_protobuf_empty_pb.Empty>;
  deleteBlynkIntegration: grpc.MethodDefinition<api_application_pb.DeleteBlynkIntegrationRequest, google_protobuf_empty_pb.Empty>;
...
export interface IApplicationServiceServer extends grpc.UntypedServiceImplementation {
  ...
  createBlynkIntegration: grpc.handleUnaryCall<api_application_pb.CreateBlynkIntegrationRequest, google_protobuf_empty_pb.Empty>;
  getBlynkIntegration: grpc.handleUnaryCall<api_application_pb.GetBlynkIntegrationRequest, api_application_pb.GetBlynkIntegrationResponse>;
  updateBlynkIntegration: grpc.handleUnaryCall<api_application_pb.UpdateBlynkIntegrationRequest, google_protobuf_empty_pb.Empty>;
  deleteBlynkIntegration: grpc.handleUnaryCall<api_application_pb.DeleteBlynkIntegrationRequest, google_protobuf_empty_pb.Empty>;
...
export class ApplicationServiceClient extends grpc.Client {
  ...
  createBlynkIntegration(argument: api_application_pb.CreateBlynkIntegrationRequest, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  createBlynkIntegration(argument: api_application_pb.CreateBlynkIntegrationRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  createBlynkIntegration(argument: api_application_pb.CreateBlynkIntegrationRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  getBlynkIntegration(argument: api_application_pb.GetBlynkIntegrationRequest, callback: grpc.requestCallback<api_application_pb.GetBlynkIntegrationResponse>): grpc.ClientUnaryCall;
  getBlynkIntegration(argument: api_application_pb.GetBlynkIntegrationRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<api_application_pb.GetBlynkIntegrationResponse>): grpc.ClientUnaryCall;
  getBlynkIntegration(argument: api_application_pb.GetBlynkIntegrationRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<api_application_pb.GetBlynkIntegrationResponse>): grpc.ClientUnaryCall;
  updateBlynkIntegration(argument: api_application_pb.UpdateBlynkIntegrationRequest, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  updateBlynkIntegration(argument: api_application_pb.UpdateBlynkIntegrationRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  updateBlynkIntegration(argument: api_application_pb.UpdateBlynkIntegrationRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  deleteBlynkIntegration(argument: api_application_pb.DeleteBlynkIntegrationRequest, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  deleteBlynkIntegration(argument: api_application_pb.DeleteBlynkIntegrationRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
  deleteBlynkIntegration(argument: api_application_pb.DeleteBlynkIntegrationRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<google_protobuf_empty_pb.Empty>): grpc.ClientUnaryCall;
